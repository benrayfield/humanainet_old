package humanainet.securehashofbits.gnu_crypto_noencryption_securehashonly_todoTestCodeAgain;
...
public abstract class BaseHash{
   ...
   /** Optionally call this after many update funcs on bytes to put the last 1-7 bits */
   public void updateLastBits(boolean... oneToSevenBits){
	   throw new UnsupportedOperationException("TODO in some subclasses allow number of bits not a multiple of 8");
   }
