...
public class AppendableTree extends ArrayList<Appendable> implements Appendable{

	public Appendable append(CharSequence c) throws IOException{
		for(Appendable child : this) child.append(c);
		return this;
	}

	public Appendable append(CharSequence c, int start, int end) throws IOException{
		for(Appendable child : this) child.append(c, start, end);
		return this;
	}
